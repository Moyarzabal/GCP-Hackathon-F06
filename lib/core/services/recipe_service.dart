  ...
  static const Map<String, List<Recipe>> _recipesByCategory = {
    '飲料': [
      Recipe(
        ...
        steps: ['フルーツを適当な大きさに切る', 'ミキサーに材料を入れる', '滑らかになるまで攪拌する', 'グラスに注いで完成'],
        category: '飲料',
      ),
      Recipe(
        id: 'drink_2',
      ...
      Recipe(
        ...
        steps: ['鍋に牛乳を温める', 'ココアパウダーと砂糖を混ぜる', '温めた牛乳に加えて混ぜる', 'バニラエッセンスを加えて完成'],
        category: '飲料',
      ),
    ],
    '食品': [
      Recipe(
        ...
        imageUrl:
            'https://images.unsplash.com/photo-1563379091339-03246963d4b0?w=400',
        cookingTime: '15分',
        ingredients: ['キャベツ', '人参', 'ピーマン', 'もやし', '醤油', 'ごま油'],
        steps: ['野菜を食べやすい大きさに切る', 'フライパンに油を熱する', '野菜を炒める', '調味料で味付けして完成'],
        category: '食品',
      ),
      Recipe(
        id: 'food_2',
      ...
      Recipe(
        ...
        steps: ['野菜を洗って適当な大きさに切る', 'ボウルに野菜を盛り付ける', 'ドレッシングをかける', 'よく混ぜて完成'],
        category: '食品',
      ),
    ],
    '調味料': [
      ...
      Recipe(
        ...
        steps: ['野菜をみじん切りにする', 'フライパンで野菜を炒める', 'トマトを加えて煮込む', '調味料で味を整える'],
        category: '調味料',
      ),
      Recipe(
        id: 'seasoning_3',
        ...
        steps: ['調味料を混ぜ合わせる', 'にんにくと生姜をすりおろす', 'すべてを混ぜ合わせる', '冷蔵庫で冷やして完成'],
        category: '調味料',
      ),
    ],
    '冷凍食品': [
      Recipe(
        ...
        steps: ['フライパンを熱する', '冷凍野菜をそのまま炒める', '調味料を加える', '火が通ったら完成'],
        category: '冷凍食品',
      ),
      Recipe(
        id: 'frozen_2',
        ...
        steps: ['フライパンに油をひく', '餃子を並べて焼く', '水を加えて蒸し焼きにする', 'パリパリになるまで焼く'],
        category: '冷凍食品',
      ),
      Recipe(
        id: 'frozen_3',
        ...
        steps: ['冷凍ピザを解凍する', '追加の具材をトッピング', 'オーブンで焼く', 'チーズが溶けたら完成'],
        category: '冷凍食品',
      ),
    ],
    'その他': [
      Recipe(
        ...
        steps: ['ご飯を適温にする', '手に塩をつける', 'ご飯を握る', '海苔を巻いて完成'],
        category: 'その他',
      ),
      Recipe(
        id: 'other_2',
        ...
        steps: ['材料を混ぜ合わせる', '生地を作る', 'オーブンで焼く', '冷まして完成'],
        category: 'その他',
      ),
      Recipe(
        id: 'other_3',
        ...
        steps: ['野菜を切る', '鍋に水を入れて煮る', 'コンソメを加える', '調味料で味を整える'],
        category: 'その他',
      ),
    ],
  };
