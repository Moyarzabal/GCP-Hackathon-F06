...
- **Preview** - プルリクエスト → 一時プレビュー環境
- **Branch** - その他ブランチ → ブランチ専用プレビュー

### ワークフロー
- **CI Pipeline** - テスト、解析、ビルドチェック
- **自動デプロイ** - Firebase Hosting連携
- **プレビュー環境** - PR作成時に自動生成
- **コードカバレッジ** - 自動テスト実行とレポート

詳細な設定方法は [`docs/ci-cd-setup.md`](./docs/ci-cd-setup.md) を参照してください。
