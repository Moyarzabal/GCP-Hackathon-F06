...
// in barcode_scanner/test/features/auth/data/repositories/auth_repository_test.dart.
...
import 'package:barcode_scanner/features/auth/data/datasources/firebase_auth_datasource.dart'
    as _i4;
import 'package:barcode_scanner/features/auth/domain/entities/user.dart' as _i2;
...
class MockFirebaseAuthDatasource extends _i1.Mock
  ...
  @override
  _i5.Future<_i2.User> signInWithEmail(String? email, String? password) =>
      (super.noSuchMethod(
  ...
  @override
  _i5.Future<_i2.User> createAccount(
    String? email,
    String? password,
    String? displayName,
  ) =>
  ...
  @override
  _i5.Stream<_i2.User?> watchAuthStateChanges() =>
      (super.noSuchMethod(
  ...
  @override
  _i5.Future<_i2.User> updateProfile({String? displayName, String? photoUrl}) =>
      (super.noSuchMethod(
